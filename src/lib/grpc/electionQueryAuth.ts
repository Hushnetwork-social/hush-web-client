...
const METHOD_ADDRESS_FIELD = new Map<string, string>([
  ...
  ['GetElectionAnomalyOwnThread', 'ActorPublicAddress'],
  ['GetElectionAnomalyTrusteeCounts', 'ActorPublicAddress'],
  ['GetElectionAnomalyOwnerTriage', 'ActorPublicAddress'],
  ['GetElectionAnomalyAuditorRestrictedReview', 'ActorPublicAddress'],
  ['GetElectionAnomalyEvidenceManifest', 'ActorPublicAddress'],
  ['StageElectionAnomalyRestrictedPayload', 'ActorPublicAddress'],
  ['GetElectionAnomalyRestrictedPayload', 'ActorPublicAddress'],
