...
export const MentionNavButton = memo(function MentionNavButton({
  ...
  return (
    ...
    >
      ...
      <span
        className="absolute top-0 right-0 translate-x-1/2 -translate-y-1/2 z-10 flex items-center justify-center w-5 h-5 aspect-square bg-red-500 text-white text-[10px] font-bold rounded-full"
        aria-hidden="true"
      >
        {displayCount}
      </span>
