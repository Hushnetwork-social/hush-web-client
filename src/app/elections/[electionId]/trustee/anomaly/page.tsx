...
import { TrusteeAnomalyWorkspacePanel } from '@/modules/elections/TrusteeAnomalyWorkspacePanel';
import { useAppStore } from '@/stores';

type TrusteeAnomalyPageProps = {
  params: Promise<{
    electionId: string;
  }>;
};

export default function ElectionTrusteeAnomalyPage({ params }: TrusteeAnomalyPageProps) {
