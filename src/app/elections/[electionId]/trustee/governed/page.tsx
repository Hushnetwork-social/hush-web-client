...
import { TrusteeGovernedActionsPanel } from '@/modules/elections/TrusteeGovernedActionsPanel';
import { useAppStore } from '@/stores';

type TrusteeGovernedPageProps = {
  params: Promise<{
    electionId: string;
  }>;
};

export default function ElectionTrusteeGovernedPage({ params }: TrusteeGovernedPageProps) {
