...
import { ElectionOwnAnomalyWorkspacePanel } from '@/modules/elections/ElectionOwnAnomalyWorkspacePanel';
import { useAppStore } from '@/stores';

type ElectionOwnAnomalyPageProps = {
  params: Promise<{
    electionId: string;
  }>;
};

export default function ElectionOwnAnomalyPage({ params }: ElectionOwnAnomalyPageProps) {
