...
import { AuditorAnomalyWorkspacePanel } from '@/modules/elections/AuditorAnomalyWorkspacePanel';
...
export default function ElectionAuditorAnomalyPage({ params }: AuditorAnomalyPageProps) {
