...
import { OwnerAnomalyWorkspacePanel } from '@/modules/elections/OwnerAnomalyWorkspacePanel';
import { useAppStore } from '@/stores';

type OwnerAnomalyPageProps = {
  params: Promise<{
    electionId: string;
  }>;
};

export default function ElectionOwnerAnomalyPage({ params }: OwnerAnomalyPageProps) {
